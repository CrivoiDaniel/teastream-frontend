...
export type ChangesNotificationsSettingsInput = {
...
export type ChnangeChatSettingsInput = {
...
export type MutationChangeNotificationsSettingsArgs = {
  data: ChangesNotificationsSettingsInput;
};
